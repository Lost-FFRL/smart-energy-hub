-- 创建数据库
CREATE DATABASE IF NOT EXISTS `smart-energy-hub` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE `smart-energy-hub`;
...
-- 插入测试数据
INSERT INTO `demo` (`name`, `description`, `status`, `sort_order`, `created_by`, `updated_by`, `remark`) VALUES
('测试数据1', '这是第一条测试数据', 1, 1, 'system', 'system', '测试备注1'),
